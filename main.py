...
def parse_args():
    ...
    # LoRA parameters
    parser.add_argument("--use_lora", type=bool, default=False, help="use LoRA-style codebook bias")
    parser.add_argument("--lora_rank", type=int, default=8, help="LoRA rank for low-rank decomposition")
